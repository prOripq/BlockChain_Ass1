...
mod tests {
    ...
    async fn test_cryptopanic_api() {
        let api_key = env::var("CRYPTOPANIC_API_KEY").unwrap_or_else(|_| "485f0f7383731d6aa0593e19716525df099ca7f4".to_string());
        let api = cryptopanic::CryptoPanicApi::new(api_key);
        
        // This test will be skipped if using the placeholder API key
        if api_key == "485f0f7383731d6aa0593e19716525df099ca7f4" {
